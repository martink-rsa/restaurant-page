...
const intro = (() => {
  const displayToPage = () => {
    ...
    introMainContainer.classList.add('intro-main-container');
    ...
    introMainContainer.appendChild(logoMainContainer);

    /* ENTER container */
    const enterContainer = document.createElement('div');
    enterContainer.id = 'intro-enter';
    ...
    introMainContainer.appendChild(enterContainer);


    mainContentDisplayContainer.appendChild(introMainContainer);
  };
